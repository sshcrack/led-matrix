...
namespace Scenes {
    ...
    private:
        ...
        PropertyPointer<Color> base_color = MAKE_PROPERTY("base_color", Color, 0x00FF00); // Default green
        ...
        uint32_t get_bar_color(int band_index, float intensity, int num_bands);
